...
@section('content')
    ...
    <div class="sm:container mx-auto p-10 font-sans text-gray-100 sm:my-36 sm:space-y-24 flex justify-center flex-col">
        ...
        <div class="flex flex-col justify-center text-center sm:space-y-5">
            <h1 class="text-4xl">Layanan Kami</h1>
            <p class="text-2xl text-gray-500 sm:w-1/2 sm:mx-auto">
                100% usaha kami adalah memberikan pelayanan terbaik untuk keluhan dan pengaduan masalah anda.
            </p>
        </div>
        {{-- end Tentang --}}
        {{-- Layanan --}}
        <div class="flex sm:flex-row sm:flex-wrap sm:justify-center gap-4 font-mono sm:w-full">
            <div class="flex flex-col sm:w-1/4 text-center sm:space-y-5 p-5 bg-gray-900 rounded-md">
                <h1 class="border-b border-gray-500 sm:text-xl pb-2">Perbaikan Jalan</h1>
                <p class="text-gray-500 px-5">
            ...
            </div><div class="flex flex-col sm:w-1/4 text-center sm:space-y-5 p-5 bg-gray-900 rounded-md">
                <h1 class="border-b border-gray-500 sm:text-xl pb-2">Perbaikan Jalan</h1>
                <p class="text-gray-500 px-5">
                    Lorem ipsum dolor, sit amet consectetur adipisicing elit. Temporibus, suscipit! Unde, molestias. Laboriosam aperiam, magnam reiciendis
                </p>
